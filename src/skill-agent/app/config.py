...
USE_LITELLM_PROXY = _to_bool(os.getenv("USE_LITELLM_PROXY", "FALSE"))
LITELLM_PROXY_API_BASE = os.getenv("LITELLM_PROXY_API_BASE", "http://localhost:4000/v1")
LITELLM_PROXY_API_KEY = os.getenv("LITELLM_PROXY_API_KEY", "")
LITELLM_PROXY_MODEL = os.getenv("LITELLM_PROXY_MODEL", "ollama/gemma3:4b.ollama")